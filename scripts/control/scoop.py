...
class RealScoopingWorld:
    def __init__(self):
        ...
        if PERCEPTION_ON:
            ...
            msg = rospy.wait_for_message_("ltamp_perception/belief", Belief, self._obj_belief_cb)
	    ...
	    print("Gripper quat", gripper_quat)
            #arm_pos = self.uc.get_arm_positions('r')
        """
	...
	start_joint_angles = [-0.9885988974424886, -0.42866951929131947, -2.0601149722539223, -2.027487019764564, -4.805082087594098, 0.019334745690731014, 21.143749123300427]
        ...
        self.uc.command_arm(self.arm, start_joint_angles, 4, blocking=True)
